...
namespace WebCinema.Migrations
{
    ...
    [Migration("20240413020051_adding the missing question mark in the movie.cs")]
    partial class addingthemissingquestionmarkinthemoviecs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WebCinema.Models.Ticket", b =>
                {
                    ...
                    b.HasOne("WebCinema.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
